...
icad q controller show-cmp-controller-result $WALLET_1 --node tcp://localhost:16657
...
# Change cmp_config.json to set WALLET_1 kyc = true
...
# Change either the transaction or offchain json file.
icad tx controller submit-tx \
"{
    \"@type\":\"/cosmos.interchainaccounts.nameservice.MsgCmpBuy\",
    \"creator\": \"$ICA_ADDR\",
...
python3 scripts/query_status.py -r "testcontroller.com:::$ICA_ADDR" -w $WALLET_1 -ica $ICA_ADDR
This time it shows success message
icad q nameservice list-whois
-------------------------------
...
"{
    ...
    \"creator\": \"$ICA_ADDR\",
    \"request\":\"testcontroller.com:::cosmos1cpxwdxfhl9rj9etvaaxtqzrjxs48xn3rkarm35mnk5y2gfsutcjs4elegg\"
}" connection-0 --from $WALLET_1 --chain-id test-1 --home ./data/test-1 --node tcp://localhost:16657 --keyring-backend test -y
...
"{
    \"@type\":\"/cosmos.interchainaccounts.nameservice.MsgQueryCmpStatus\",
    \"creator\": \"cosmos1ejps98g4rqrdnqqddfuwxy9dv8wz6za3q66c9vz0krq4g84ueecqn79lus\",
