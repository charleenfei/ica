export default function balance(req, res) {
  ...
  export Balance1=$(icad q bank balances $ICA_ADDR --chain-id test-2 --home ~/cosmos/sbip/data/test-2 -o json |  jq -r \'.balances[].amount\');\
  echo "Balance of ICA Address 1:" $Balance1;\
  echo "";'
